...
// Vehicle body
  ...
  Modelica.Blocks.Interfaces.RealOutput outAngvFront annotation(
    Placement(visible = true, transformation(origin = {148, 164}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {148, 164}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput outAngvLeft annotation(
    Placement(visible = true, transformation(origin = {150, 124}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {150, 124}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput outAngvRight annotation(
    Placement(visible = true, transformation(origin = {150, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {150, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
...
// Outputs
  ...
  outAngvFront = frontWheel.w_roll;
  outAngvLeft = rearLeftWheel.w_roll;
  outAngvRight = rearRightWheel.w_roll;
// Debug
